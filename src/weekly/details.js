...
  if (!currentWeekId) {
    weekTitle.textContent = "Week not found. Missing 'id' parameter in URL.";
    return;
  }
...
    } else {
      weekTitle.textContent = `Week not found for ID: ${currentWeekId}`;
    }

  } catch (error) {
    console.error('Error initializing page:', error);
    weekTitle.textContent = 'Error loading page content.';
  }
}
